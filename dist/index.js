...
const cons = __webpack_require__(619)
...
const touch_1 = __importDefault(__webpack_require__(549));
            ...
            if (err || data.Credentials == null) {
                ...
                if (writeCredentialsFile) {
                    try {
                        ...
                        touch_1.default.sync(credentialsFilePath);
